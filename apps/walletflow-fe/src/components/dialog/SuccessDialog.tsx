...
const SuccessDialog = ({text,logo,submitText}:{text:string,logo:string,submitText:string}) => {
  ...
  return (
    <CustomDialog className='bg-white  w-[300px] '>
        <div className='flex flex-col justify-center items-center space-y-8  text-black'>
         ...
         <p className=' text-base text-center font-semibold'>{text}</p>
         <Button className='w-full text-base' onClick={()=>closeDialog()}>{submitText}</Button>
        </div>
